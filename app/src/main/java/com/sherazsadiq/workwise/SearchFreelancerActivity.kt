...
class SearchFreelancerActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonGoBack = findViewById<ImageView>(R.id.button_goback)
        buttonGoBack.setOnClickListener {
            finish()
        }

        val buttonGotoGig1 = findViewById<FrameLayout>(R.id.button_gotoGig1)
        buttonGotoGig1.setOnClickListener {
